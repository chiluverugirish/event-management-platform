...
exports.cancelTicket = exports.getMyTickets = exports.bookTicket = void 0;
...
const bookTicket = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        let paymentResult;
        try {
            paymentResult = yield (0, payment_1.processPayment)(price, type, user.email, { eventId, userId, eventTitle: event.title, paymentMethod });
        }
        catch (paymentError) {
            yield transaction.rollback();
        ...
        const isPaymentValid = yield (0, payment_1.verifyPayment)(paymentResult.paymentId);
        if (!isPaymentValid) {
            yield transaction.rollback();
        ...
        let qrCode;
        try {
            qrCode = yield qrcode_1.default.toDataURL(qrData);
        }
        catch (qrError) {
            yield transaction.rollback();
        ...
        try {
            yield Attendee_1.default.create({
                ticketId: ticket.id,
                name: user.name,
                email: user.email,
                checkedIn: false
        ...
        try {
            ...
            const folderPath = path_1.default.join(__dirname, "../../tickets");
            fs_1.default.mkdirSync(folderPath, { recursive: true });
            fs_1.default.writeFileSync(path_1.default.join(folderPath, filename), base64Data, "base64");
...
const cancelTicket = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // Get event details
        const event = yield Event_1.default.findByPk(ticket.eventId, {
            lock: transaction.LOCK.UPDATE,
            transaction
        });
        if (!event) {
        ...
        if (ticket.paymentStatus === 'completed' && ticket.paymentId) {
            try {
                ...
                refundResult = yield refundPayment(ticket.paymentId);
